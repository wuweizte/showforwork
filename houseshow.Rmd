...
2）一年以来，深圳新房出现了3%左右的价格回调，与之相反的是，二手房出现了5%左右的上涨。可能是这个原因促使深圳在3月底推出“三价合一”政策来平抑二手房的涨势。由于深圳房市以存量房为主，所以二手房价格走势代表了市场主流走势。新房、二手房价格倒挂体现了新房价格被扭曲的可能，不过，这也从侧面反映了管理层抑制房价膨胀的决心。

3）一年以来，二线城市房价情况：厦门的二手住宅出现5%左右的价格回调。南京的二手住宅出现3%左右的价格回调。西安二手房出现则了10%左右的价格增长。

4）一年以来，西安新房、二手房同时出现了10%左右的价格上涨，与一线城市对比明显。根据媒体报道，2017年西安出台了“史上最宽松户籍政策”，全年引进各类人才约20.9万人。而西安每年新推出的新房源为10余万套的规模，所以可能短期出现了房源供不应求的情况。
...
```{r , fig.height=10, fig.width=14, echo=FALSE,eval=FALSE,fig.show='hide'}
source("D:\\MyR\\house\\produce_map_report_for_house_price.R")
```

```{r , fig.height=9, fig.width=15,echo=FALSE,eval=FALSE}
library("png")
...
```{r , fig.height=10, fig.width=18, echo=FALSE,eval=FALSE, fig.show='hide'}
...
一年以来，深圳新房出现了3%左右的价格回调，与之相反的是，二手房出现了5%左右的上涨。可能是这个原因促使深圳在3月底推出“三价合一”政策来平抑二手房的涨势。由于深圳房市以存量房为主，所以二手房价格走势代表了市场主流走势。新房、二手房价格倒挂体现了新房价格被扭曲的可能，不过，这也从侧面反映了管理层抑制房价膨胀的决心。

一年以来，二线城市房价情况：厦门的二手住宅出现5%左右的价格回调。南京的二手住宅出现3%左右的价格回调。

一年以来，西安新房、二手房同时出现了10%左右的价格上涨，与一线城市对比明显。根据媒体报道，2017年西安出台了“史上最宽松户籍政策”，全年引进各类人才约20.9万人。而西安每年新推出的新房源为10余万套的规模，所以可能短期出现了房源供不应求的情况。


### 热点城市样本楼盘房价跟踪

```{r , fig.height=10, fig.width=18, echo=FALSE,eval=TRUE}
# options(width = 300)
...
### 全国商品房销售/待售面积跟踪
```{r , fig.height=10, fig.width=18, echo=FALSE,eval=FALSE}
# options(width = 300)
